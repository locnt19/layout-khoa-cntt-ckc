...
function eventClickHighLightHome() {
  ...
  $('.highlight_home__slider__thumbnail .highlight_home__slider__item').click(function () {
    ...
    var title = $(this).children('.highlight_home__sub_title').text();

    var _short = $(this).children('.highlight_home__sub_desc').text();

    var postTime = $(this).children('.highlight_home__sub_postedtime').text();
